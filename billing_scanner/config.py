...
class Config:
    def __init__(self) -> None:
        ...
        self.AWS_IP_RANGES_URL = os.getenv("AWS_IP_RANGES_URL", "https://ip-ranges.amazonaws.com/ip-ranges.json")
        self.FALLBACK_IP_RANGES_FILE = os.getenv("FALLBACK_IP_RANGES_FILE", "/mnt/state/fallback_ip_ranges.json")
